                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mt-2">
                                            <h5 class="mb-75" style="font-weight:bold;">تاريخ الميلاد</h5>
                                            <p class="card-text">{{ $user->birthday }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mt-2">
                                            <h5 class="mb-75" style="font-weight:bold;">الجنس</h5>
                                            <p class="card-text">{{ ($user->gender == App\Enums\GenderEnum::Male->value) ? 'ذكر' : 'آنثى' }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
