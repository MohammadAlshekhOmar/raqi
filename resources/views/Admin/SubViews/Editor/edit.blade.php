                ...
                <div class="modal-body flex-grow-1">
                        ...
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <input type="text" name="email" class="form-control dt-email"
                                    value="{{ $editor->email }}" placeholder="أدخل البريد الإلكتروني" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-1">
                                <label class="form-label">رقم الهاتف المحمول</label>
                                <input type="number" name="phone" class="form-control" value="{{ $editor->phone }}"
                    ...
                    <div class="row">
                            ...
                            <div class="mb-1">
                                ...
                                <select class="select2 form-control" name="role_id">
                                    ...
                                    @foreach ($roles as $role)
                                        <option {{ $editor->roles()?->first()?->name == $role->name ? 'selected' : null }}
                        ...
                        <div class="col-md-6">
                            ...
                            <img id="show_image" src="{{ $editor->image }}" style="width:200px;height:200px;margin:20px;"
                                alt="editor image" />
                        </div>
                    </div>
                </div>
