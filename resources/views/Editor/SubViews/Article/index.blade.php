            ...
            <form class="modal-content pt-0" id="addForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="editor_id" value="{{ auth('editor')->user()->id }}">
                        <div class="card">
                            <div class="card-body">
        ...
        $(document).on('submit', '#editForm', function(event) {
            ...
            $.ajax({
                ...
                success: function(response, textStatus, xhr) {
                    ...
                    $('#sid' + response.data.id).find("td").eq(2).html(response.data.title);
                    $('#sid' + response.data.id).find("td").eq(3).html(response.data.text);
