            ...
            <ul class="nav navbar-nav">
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <span class="">
                            <img style="width: 50px;" src="{{ asset(mix('images/logo.jpg')) }}" alt="" />
                        </span>
...
@else
    ...
    {{ $configData['navbarClass'] }} navbar-light navbar-shadow 
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                    ...
                    <span class="avatar">
                        <img class="round" src="{{ auth($guard)->user()->image }}" alt="avatar" height="40"
                            width="40">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item"
                        href="{{ route($guard . '.' . $route . '.showEdit', ['id' => auth($guard)->user()->id]) }}">
